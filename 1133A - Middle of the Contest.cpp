...
int32_t main()
{
    ...
    string S, E;
    cin >> S >> E;
    int Hi = (S[0]-'0')*10 + S[1]-'0', Mi = (S[3]-'0')*10 + S[4]-'0';
    int Hf = (E[0]-'0')*10 + E[1]-'0', Mf = (E[3]-'0')*10 + E[4]-'0';
    int M1 = (Hi*60)+Mi, M2 = (Hf)*60+Mf;
    // cout << M1 << " " << M2;
    int T = (M1+M2)/2;
    Hi = T/60, Mi = T%60;
    if(Hi<10 && Mi<10) cout << "0" << Hi << ":0" << Mi;
    else if(Hi<10) cout << "0" << Hi << ":" << Mi;
    else if(Mi<10) cout << Hi << ":0" << Mi;
    else cout << Hi << ":" << Mi;
    return 0;
}