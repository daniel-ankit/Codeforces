...
int32_t main()
{
    ...
    int N, num=0;
    cin >> N;
    int M1=0, M2=0, M3=0, M6=0, M4=0;
    int V124=0, V126=0, V136=0;
    for(int i=0; i<N; i++)
    {
        cin >> num;
        if(num==1) M1++;
    ...
    {
        while(V124--) cout << "1 2 4\n";
        while(V126--) cout << "1 2 6\n";
        while(V136--) cout << "1 3 6\n";
    }
    return 0;
}
